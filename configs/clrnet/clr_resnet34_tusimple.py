...
test_parameters = dict(conf_threshold=0.20, nms_thres=50, nms_topk=max_lanes)

epochs = 50
batch_size = 8

optimizer = dict(type='AdamW', lr=3.0e-4)  # 3e-4 for batchsize 8
...
dataset_path = '/workspace/SESSION_D'
dataset_type = 'TuSimple'
test_json_file = '/workspace/SESSION_D/seg_label/test.json'
